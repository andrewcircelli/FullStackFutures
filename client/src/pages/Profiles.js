...
<Form className="container">
  <Form.Group controlId="formBasicText">
    ...
    <Form.Control type="text" name="university" value = {this.state.university} onChange ={this.handleInput} placeholder="Enter University" />
    </Form.Group>
    ...
    <Form.Control type="number" name="GPA" value = {this.state.GPA} onChange ={this.handleInput} placeholder="Enter GPA" />
    </Form.Group>

    <Form.Group controlId="formBasicNumber">
    <Form.Label>SAT</Form.Label>
    <Form.Control type="number" name="SAT" value = {this.state.SAT} onChange ={this.handleInput} placeholder="Enter SAT" />
    </Form.Group>

    <Form.Group controlId="formBasicNumber">
    <Form.Label>ACT</Form.Label>
    <Form.Control type="number" name="ACT" value = {this.state.ACT} onChange ={this.handleInput} placeholder="Enter ACT" />
    </Form.Group>
